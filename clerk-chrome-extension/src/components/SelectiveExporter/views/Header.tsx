...
const onIconButtonMouseEnter = (e: React.MouseEvent<HTMLButtonElement>) => {
  e.currentTarget.style.background = DARK_THEME.borderSubtle
  e.currentTarget.style.color = DARK_THEME.text
}

const onIconButtonMouseLeave = (e: React.MouseEvent<HTMLButtonElement>) => {
      ...
      <div style={{ padding: "16px 20px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            {/* Message index icon */}
            <button onClick={onIndexClick} title="Message index" style={iconButtonStyle} onMouseEnter={onIconButtonMouseEnter} onMouseLeave={onIconButtonMouseLeave}>
            ...
            {/* Settings gear icon */}
            <button onClick={onSettingsClick} title="Settings" style={iconButtonStyle} onMouseEnter={onIconButtonMouseEnter} onMouseLeave={onIconButtonMouseLeave}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
